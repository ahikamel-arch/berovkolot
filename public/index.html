...
// בדיקת גרסה - לוודא שהשרת שרץ הוא באמת הקוד העדכני
app.get('/version', (req, res) => {
  res.json({ version: VERSION, skipSupported: true });
});
...
const TARGET_SCORE = Number(process.env.TARGET_SCORE) || 15;
const MAX_QUESTIONS = Number(process.env.MAX_QUESTIONS) || 25;
...
const rawQuestions = [
  ...
  // --- סגנון חדש: שאלות היפותטיות ודמיוניות ---
  "אם היינו להקת רוק, מי היה הסולן הראשי?",
  "אם היינו נתקעים במעלית לשעתיים, מי היה שומר על קור רוח?",
  "אם היינו שבט בהישרדות, מי היה מודח ראשון?",
  "אם היינו מקימים סטארטאפ ביחד, מי היה המנכ\"ל?",
  "אם החבורה הייתה סרט, מי היה הנבל?",
  "אם היה אפשר לשלוח אחד מאיתנו לחלל, את מי היינו שולחים?",
  "אם היינו צוות שוד בסרט, מי היה המוח מאחורי התוכנית?",
  "אם היינו כיתה בבית ספר, מי היה יושב בשולחן האחורי ומפריע?",
  "אם היינו פותחים מסעדה ביחד, מי היה השף?",
  "אם היינו תקועים על אי בודד, מי היה מוצא דרך להכין קפה?",
  "אם היינו קבוצת גיבורי-על, מי היה מקבל את כוח העל הכי מיותר?",
  "אם היינו ממלכה מימי הביניים, מי היה יושב על כס המלוכה?",
  "אם היינו קרקס, מי היה הליצן הראשי?",
  "אם היינו משפחת מאפיה, מי היה הסנדק?",
  "בגלגול הקודם, מי מאיתנו היה חתול?",
  "בגלגול הקודם, מי היה כלב נאמן?",
  "בגלגול הבא, מי יחזור בתור עציץ?",
  "אם היינו תוכנית בישול, מי היה השופט הקשוח?",
  "מי היה שורד הכי הרבה זמן בסרט אימה?",
  "מי היה הדמות הראשונה שנעלמת בסרט אימה?",
  "עוד 100 שנה, על מי מאיתנו יכתבו בספרי ההיסטוריה?",
  "אם היה לנו ערוץ יוטיוב משותף, מי היה זה שעורך את כל הסרטונים?",
  "מי מאיתנו היה יכול להיות פוליטיקאי מצליח?",
  "אם היינו יוצאים למירוץ למיליון, עם מי הכי כדאי להיות בזוג?",
  "אם מחר מכתירים מלך, מי מאיתנו הכי מתאים לתפקיד?",
  "אם כולנו היינו גרים בבית אחד, מי היה קובע את הכללים?",
  "ואם כולנו היינו גרים בבית אחד, מי היה שוכח לשטוף כלים?",
  "אם החבורה הייתה סדרת טלוויזיה, על שם מי היו קוראים לה?",
  "מי מאיתנו היה מצליח בתור סטנדאפיסט?",
  "אם הייתה מכונת זמן, מי היה נוסע לעבר רק כדי לתקן רגע מביך?",
  "מי היה מסתדר הכי טוב בעולם בלי טלפונים ניידים?",
  "אם היינו חיות בגן חיות, מי היה הקוף שכולם באים לצלם?",
  "מי מאיתנו היה יכול להפוך למורה רוחני עם מיליון עוקבים?",
  "אם היינו צבא, מי היה הגנרל?",
  "ואם היינו צבא, מי היה נרדם בשמירה?",
  "אם הייתה תחרות 'מלך השקט', מי היה מפסיד ראשון?",
  "מי מאיתנו הכי מתאים להגיש את מהדורת החדשות?",
  "אם היינו מגש פירות, מי היה האבטיח?",
  "אם היינו ועד בית, מי היה גובה את הכסף בלי שום בושה?",
  "מי היה מנצח את כולם בתחרות טריוויה?",
  "מי היה שורד הכי פחות זמן בלי אינטרנט?",
  "מי רוקד ראשון על הרחבה בחתונה?",
  "אם היה משאל 'האדם הכי חכם בחדר', מי היה מצביע לעצמו?",
  "מי מאיתנו היה מצליח למכור קרח לאסקימוסים?",
  "אם היינו אגדה עתיקה, מי היה הדרקון?",
  "עוד 20 שנה, מי מאיתנו ייראה הכי צעיר?",
  "עוד 20 שנה, מי יגור הכי רחוק מכולם?",
  "מי היה מחזיק מעמד הכי הרבה זמן לבד בחדר בריחה?",
  "אם היה פרס נובל לחפירות, מי היה זוכה בו?",
  "אם היינו פלייליסט, מי היה השיר שכולם מדלגים עליו?"
];
...
io.on('connection', (socket) => {
  ...
  socket.on('next_question', (data) => {
    ...
    // באמצע שאלה פתוחה אין "שאלה הבאה" - לזה יש את כפתור הדילוג (שלא נספר במניין)
    if (room.roundActive) {
      socket.emit('host_action_error', 'יש שאלה פתוחה כרגע - כדי להחליף אותה השתמש בכפתור הדילוג.');
      return;
    }

    // אחרי סיום המשחק אפשר רק להתחיל מחדש
    if (room.gameOver) {
      socket.emit('host_action_error', 'המשחק הסתיים - אפשר רק להתחיל משחק חדש.');
      return;
    }

    // הגנה: לא חורגים ממכסת השאלות
    if (room.questionsPlayed >= MAX_QUESTIONS) {
      socket.emit('host_action_error', 'הגעתם למכסת השאלות של המשחק.');
      return;
    }
  ...
  // דילוג על שאלה (מנהל בלבד) - השאלה לא נספרת במניין וההצבעות שנקלטו נמחקות
  socket.on('skip_question', (data) => {
    const reqRoomId = (data && data.roomId) ? data.roomId : socket.roomId;
    const room = rooms.get(reqRoomId);
    ...
    if (!room.roundActive) {
      socket.emit('host_action_error', 'אין כרגע שאלה פעילה לדלג עליה.');
      return;
    }
    ...
    room.currentQuestionIndex++;
    room.currentQuestion = q;
    // שימו לב: questionsPlayed לא גדל - שאלה שדולגה לא נחשבת
...
server.listen(PORT, () => console.log(`Server v${VERSION} running on port ${PORT} (skip_question supported)`));

...
const MAX_QUESTIONS = 25; // מספר השאלות שישוחקו בסיבוב אחד מתוך ה-300

// 🎯 מאגר מלא של 300 שאלות "ברוב קולות"
const rawQuestions = [
  // השאלות שלך:
...
function resetAndShuffleQuestions() {
  // ערבוב אקטיבי של כל 300 השאלות בכל תחילת משחק
...
io.on('connection', (socket) => {
  ...
  socket.on('restart_game', () => {
    ...
    // ערבוב חדש לחלוטין מתוך כל 300 השאלות בתחילת משחק
    resetAndShuffleQuestions();
